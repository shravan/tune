class RecipesController < ApplicationController
 ...
 def export_to_pdf
   objPDF = PDF::Writer.new
   recipe = Recipe.find(params[:id])
   objPDF.text "Hello, Ruby. #{web_friendly_text(recipe.description)}", :font_size => 10, :justification => :left
   send_data objPDF.render, :filename => "filename", :type => "application/pdf", :charset => "utf-8"
 end
